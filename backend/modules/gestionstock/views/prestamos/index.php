...
<div class="prestamos-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
            	'attribute' => 'idPresta','label' => 'Préstamo número','value' => 'idPresta',
    		], 
			[
				'label' => 'Estudiante',
            ...
            [
            	'attribute' => 'FechaPresta','label' => 'Fecha retiro','value' => 'FechaPresta'
    		],
    		[
				'attribute' => 'FechaDebT', 'label' => 'Fecha devolución','value' => 'FechaDebT',
    		],
            [
