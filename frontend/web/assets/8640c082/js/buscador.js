const RutaWeb="http://192.168.0.42/cecv/frontend/web/index.php";
...
function Busqueda(Elemento,n,Orden,Termino){
...
function InicializarBuscador(Elemento,n,Titulo){
	...
	$('#BBusca').on('click', function() { // si se apreta el boton de busqueda
		...
		Busqueda(Elemento,n,Orden,Termino);
	});
	...
	$('#BOrdD').on('click', function() { // si se apreta el boton ordenar descendente
		...
		Busqueda(Elemento,n,Descendente,Termino);
	});
